...
addon_info = AddonInfo(
	...
	addon_name="nvdaClipboard",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("NVDA Clipboard"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""This add-on lets you collect multiple pieces of text on the clipboard without replacing the previous content.

When you select text and press NVDA+Windows+C, the selected text is appended to the clipboard instead of overwriting it. Each new selection is added on a new line, so you can repeat this command to gather text from different places.

Later, when you press paste (Control+V), all the text you copied with NVDA+Windows+C will be pasted together.

Keyboard commands:
NVDA+Windows+C – Append the selected text to the clipboard.
NVDA+Shift+Delete – Clear the clipboard (NVDA announces “Clipboard cleared”).
"""),
	# version
	addon_version="0.0.1",
